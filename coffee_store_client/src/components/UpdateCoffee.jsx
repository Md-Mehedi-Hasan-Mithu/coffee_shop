        ...
        <form onSubmit={handleUpdateCoffee}>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                ...
                <fieldset className="fieldset bg-base-200 border-base-300 rounded-box  border p-4">
                    ...
                    <input type="number" name='quantity' defaultValue={quantity} className="input w-full" placeholder="Number of Coffee" />
                </fieldset>
                <fieldset className="fieldset bg-base-200 border-base-300 rounded-box  border p-4">
                ...
                <fieldset className="fieldset bg-base-200 border-base-300 rounded-box  border p-4">
                    ...
                    <input type="text" name='price' defaultValue={price} className="input w-full" placeholder="Amount" />
                </fieldset>
                <fieldset className="fieldset bg-base-200 border-base-300 rounded-box  border p-4">
